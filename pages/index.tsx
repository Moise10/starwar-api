...
export default function Charcaters(characters) {
  ...
  return (
		<>
			<Head>
				<title>Star Wars Chracters | StarWars.com</title>
			</Head>
			<HomeScreenContainer>
				<StarfieldLeft />
				<CharactersContainer>
					{characters.characters.filter((character) => character.id !== 28 && character.id !== 77)
						.map(
							(character, index) =>
								index < value && (
